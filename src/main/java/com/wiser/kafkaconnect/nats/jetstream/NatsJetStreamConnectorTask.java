...
public class NatsJetStreamConnectorTask extends SourceTask {
    ...
    private final Logger log = LoggerFactory.getLogger(NatsJetStreamConnectorTask.class);
    ...
    public void start(Map<String, String> properties) {
        config = new NatsJetStreamConnectorConfig(properties);
