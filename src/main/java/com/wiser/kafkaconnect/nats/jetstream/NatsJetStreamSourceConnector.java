...
public class NatsJetStreamSourceConnector extends SourceConnector {

    private final Logger log = LoggerFactory.getLogger(NatsJetStreamSourceConnector.class);

    private Map<String, String> originalProps;
    private NatsJetStreamSourceConnectorConfig config;
    ...
    public Class<? extends Task> taskClass() {
        return NatsJetStreamSourceConnectorTask.class;
    }
    ...
    public void start(Map<String, String> originalProps) {
        ...
        config = new NatsJetStreamSourceConnectorConfig(originalProps);
