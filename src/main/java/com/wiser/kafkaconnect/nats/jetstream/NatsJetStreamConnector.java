...
public class NatsJetStreamConnector extends SourceConnector {

    private final Logger log = LoggerFactory.getLogger(NatsJetStreamConnector.class);

    private Map<String, String> originalProps;
    private NatsJetStreamConnectorConfig config;
    ...
    public Class<? extends Task> taskClass() {
        return NatsJetStreamConnectorTask.class;
    }
    ...
    public void start(Map<String, String> originalProps) {
        ...
        config = new NatsJetStreamConnectorConfig(originalProps);
