...
public class NatsJetStreamSourceConnectorTask extends SourceTask {
    ...
    private final Logger log = LoggerFactory.getLogger(NatsJetStreamSourceConnectorTask.class);
    ...
    public void start(Map<String, String> properties) {
        config = new NatsJetStreamSourceConnectorConfig(properties);
